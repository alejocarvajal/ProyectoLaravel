...
<script type="text/javascript">
	...
	function initialize_<?php echo $id; ?>() {
		...
		<?php $__currentLoopData = $options['markers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $marker): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			<?php echo $marker->render($key, $view); ?>

		<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>

		<?php $__currentLoopData = $options['shapes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $shape): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
